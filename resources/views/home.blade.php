...
@section('content')
            ...
            <div class="panel panel-default">
                <div class="panel-heading">{{ __('Page is not available due to authentification')}}</div>

                <div class="panel-body" >
                    Please login with a user having higher privileges or contact  to responsible persons.</br><br>
